    ...
    public partial class Pagos : System.Web.UI.Page
    {
        ...
        protected void SendEmailWithJasperPDF()
        {
            try
            {
                ...
                // Llamar al servicio y obtener el arreglo de bytes del PDF
                ...
                // Usar el byte[] directamente para crear el PDF adjunto
                using (MemoryStream ms = new MemoryStream(reporte, 0, reporte.Length, false, true))
                {
                    Attachment attachment = new Attachment(ms, "Report.pdf", "application/pdf");
                ...
                // Opcional: Guardar el reporte en Base64 como archivo .txt
                string base64String = Convert.ToBase64String(reporte);
                File.WriteAllText(@"C:\Users\Patricia\Downloads\FromServiceBase64.txt", base64String);

                // Opcional: Guardar el PDF en el sistema de archivos
                File.WriteAllBytes(@"C:\Users\Patricia\Downloads\FromService.pdf", reporte);
